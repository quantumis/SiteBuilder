...
foreach (['i18n.php', 'similar-post.php', 'geo-shortcodes.php', 'articles-grid.php', 'breadcrumbs.php', 'external-links.php', 'sitemap.php', 'seo.php', 'back-to-top.php'] as $sb_inc_file) {
