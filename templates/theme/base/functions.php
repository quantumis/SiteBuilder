...
foreach (['i18n.php', 'shortcodes.php', 'link-resolver.php', 'similar-post.php', 'geo-shortcodes.php', 'toc.php', 'articles-grid.php', 'breadcrumbs.php', 'external-links.php', 'sitemap.php', 'blocks.php', 'seo.php', 'back-to-top.php', '404-styles.php', 'content-signature.php', 'image-optimizations.php', 'tables-responsive.php'] as $sb_inc_file) {
