...
<footer class="sb-footer-card" role="contentinfo">
    <div class="sb-footer-card-inner">
        <div class="sb-footer-card-grid">
            ...
            <div class="sb-footer-card-col">
                <h2 class="sb-footer-card-heading">Contact</h2>
                ...
                <div class="sb-footer-card-social" aria-label="Social">
                    <a href="#" class="sb-footer-card-social-link" aria-label="Twitter">
                    ...
                    <a href="#" class="sb-footer-card-social-link" aria-label="Facebook">
                    ...
                    <a href="#" class="sb-footer-card-social-link" aria-label="Instagram">
